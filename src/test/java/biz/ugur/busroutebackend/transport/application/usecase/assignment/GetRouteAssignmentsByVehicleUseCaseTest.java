...
class GetRouteAssignmentsByVehicleUseCaseTest {

    @InjectMocks
    private GetRouteAssignmentsByVehicleUseCase useCase;
    ...
    @Test
    void returnsActiveAssignmentsForVehicle() {
        ...
        when(assignmentRepository.findActiveByVehicleId(vehicleId)).thenReturn(Flux.just(assignment));
