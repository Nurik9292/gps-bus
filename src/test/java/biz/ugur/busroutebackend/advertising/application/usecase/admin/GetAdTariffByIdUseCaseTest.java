...
class GetAdTariffByIdUseCaseTest {

    @InjectMocks
    private GetAdTariffByIdUseCase useCase;
    ...
    @Test
    void returnsResponseWhenTariffFound() {
        ...
        StepVerifier.create(useCase.execute(tariff.getId().getValue()))
                .assertNext(r -> assertEquals(tariff.getId().getValue(), r.id()))
                .verifyComplete();
    }
