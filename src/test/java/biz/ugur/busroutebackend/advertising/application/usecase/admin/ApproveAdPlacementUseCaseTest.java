...
class ApproveAdPlacementUseCaseTest {

    @InjectMocks
    private ApproveAdPlacementUseCase useCase;
    ...
    @Test
    void approvesDraftPlacementAndReturnsResponse() {
        ...
        StepVerifier.create(useCase.execute(
                new ApproveAdPlacementUseCase.Request(placement.getId().getValue(), "admin-1")))
                .expectNextCount(1)
                .verifyComplete();
    ...
    void errorsWhenPlacementNotFound() {
        ...
        StepVerifier.create(useCase.execute(
                new ApproveAdPlacementUseCase.Request(id, "admin-1")))
