...
class ApproveBusinessUseCaseTest {

    @InjectMocks
    private ApproveBusinessUseCase useCase;
    ...
    @Test
    void approvesBusinessAndReturnsResponse() {
        ...
        StepVerifier.create(useCase.execute(
                new ApproveBusinessUseCase.Request(pending.getId().getValue(), "admin-1")))
                .expectNextCount(1)
                .verifyComplete();
    ...
    void errorsWhenBusinessNotFound() {
        ...
        StepVerifier.create(useCase.execute(new ApproveBusinessUseCase.Request(id, "admin-1")))
