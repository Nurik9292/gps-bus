...
class GetBusinessByIdUseCaseTest {
    ...
    @InjectMocks
    private GetBusinessByIdUseCase useCase;
    ...
    void returnsBusinessWhenFound() {
        ...
        StepVerifier.create(useCase.execute(business.getId().getValue()))
                .assertNext(r -> assertEquals(business.getId().getValue(), r.id()))
                .verifyComplete();
    }
