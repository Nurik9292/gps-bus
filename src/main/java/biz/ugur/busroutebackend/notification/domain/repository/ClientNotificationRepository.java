...
public interface ClientNotificationRepository extends BaseRepository<Notification, NotificationId> {

    Flux<Notification> findActiveNotificationsWithPagination(Pageable pageable);
