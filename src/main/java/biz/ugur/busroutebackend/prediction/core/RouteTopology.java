...
public record RouteTopology(String topology, RouteLine first, RouteLine second,
    ...
    public static RouteTopology of(RouteLine g) {
        if (g.isLoop()) {
            return new RouteTopology(RouteLine.TOPOLOGY_LOOP, g, null, List.of());
        }
        ...
        return new RouteTopology(RouteLine.TOPOLOGY_THERE_AND_BACK, g, null, List.of());
    }

    public static RouteTopology thereAndBack(RouteLine dir0, RouteLine dir1) {
        return new RouteTopology(RouteLine.TOPOLOGY_THERE_AND_BACK, dir0, dir1, List.of());
    }
