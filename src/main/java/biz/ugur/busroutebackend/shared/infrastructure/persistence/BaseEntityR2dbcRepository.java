...
@Slf4j
public abstract class BaseEntityR2dbcRepository<T extends Entity<ID>, ID> implements BaseRepository<T, ID> {

    protected final DatabaseClient databaseClient;
    protected final String tableName;
    protected final Class<T> entityClass;

    protected BaseEntityR2dbcRepository(DatabaseClient databaseClient, String tableName, Class<T> entityClass) {
