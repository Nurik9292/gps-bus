...
public class R2dbcAdImpressionEventRepository implements AdImpressionEventRepository {

    private final DatabaseClient db;

    @Override
    public Mono<Void> save(AdImpressionEvent event) {
        GenericExecuteSpec spec = db.sql("""
                        INSERT INTO ad_impression_events
