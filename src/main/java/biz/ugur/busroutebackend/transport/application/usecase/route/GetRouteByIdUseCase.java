...
@Slf4j
public class GetRouteByIdUseCase implements UseCase<Mono<GetRouteByIdUseCase.Query>, Mono<RouteDetail>> {

    private final BusRouteRepository busRouteRepository;
    private final CorrelationContextService correlationService;

    @Override
    public Mono<RouteDetail> execute(Mono<Query> routeIdMono) {
