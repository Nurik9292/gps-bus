...
@Service
@Slf4j
public class GetRouteAlternativesUseCase extends BaseFluxUseCase<GetRouteAlternativesUseCase.Request, RouteAlternativeDTO> {

    private final RouteAlternativeRepository routeAlternativeRepository;
    private final BusRouteRepository busRouteRepository;

    public GetRouteAlternativesUseCase(
    ...
    @Override
    protected Flux<RouteAlternativeDTO> process(Request request) {
        ...
        return routeAlternativeRepository.findByPrimaryRouteId(primaryRouteId)
                ...
                .doOnComplete(() -> log.debug("Fetched alternatives for route: {}", request.primaryRouteId));
    }
