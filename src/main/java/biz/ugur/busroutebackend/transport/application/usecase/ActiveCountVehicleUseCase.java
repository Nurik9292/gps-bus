...
@Service
@Log4j2
public class ActiveCountVehicleUseCase extends BaseUseCase<Mono<Void>, ActiveCountVehicleUseCase.Response> {

    private final VehicleRepository vehicleRepository;

    public ActiveCountVehicleUseCase(VehicleRepository vehicleRepository,
