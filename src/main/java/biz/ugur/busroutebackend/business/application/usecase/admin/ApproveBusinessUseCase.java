...
@Service
@Slf4j
public class ApproveBusinessUseCase
        extends BaseUseCase<ApproveBusinessUseCase.Request, BusinessResponse> {

    public record Request(String businessId, String adminId) {}

    private final BusinessRepository businessRepository;
    private final BusinessResponseMapper businessResponseMapper;

    public ApproveBusinessUseCase(BusinessRepository businessRepository,
