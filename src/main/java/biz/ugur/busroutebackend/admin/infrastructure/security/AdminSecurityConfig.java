...
public class AdminSecurityConfig {
    ...
    public SecurityWebFilterChain adminSecurityFilterChain(ServerHttpSecurity http) {
        log.info("Configuring Admin Security Filter Chain for /api/v1/admin/**");
        ...
        return http
                ...
                .authorizeExchange(exchanges -> exchanges
                        ...
                        .pathMatchers("/api/v1/admin/routes/**").hasRole("ADMIN")
                        .pathMatchers("/api/v1/admin/stops/**").hasRole("ADMIN")
                        .pathMatchers("/api/v1/admin/banners/**").hasRole("ADMIN")
                        .pathMatchers("/api/v1/admin/cities/**").hasRole("ADMIN")

                        .pathMatchers("/api/v1/admin/users/**").hasRole("SUPER_ADMIN")
                        .pathMatchers("/api/v1/admin/system/**").hasRole("SUPER_ADMIN")
                        .pathMatchers(HttpMethod.GET, "/api/v1/admin/logs/**").hasRole("SUPER_ADMIN")
